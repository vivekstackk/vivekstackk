...
Responsive movie browsing website with search and detailed movie information, powered by the TMDB API.

| Attribute | Details |
|---|---|
| **Stack** | React, Node.js |
| **Repository** | [github.com/vivekstackk/cinemate](https://github.com/vivekstackk/cinemate) |
...
Peer learning platform with a modern skill-exchange system connecting users to trade knowledge.

| Attribute | Details |
|---|---|
| **Stack** | Next.js, MongoDB |
| **Repository** | [github.com/vivekstackk/skillswap](https://github.com/vivekstackk/skillswap.git) |
